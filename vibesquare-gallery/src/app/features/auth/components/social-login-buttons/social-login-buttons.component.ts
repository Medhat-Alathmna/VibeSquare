...
import { OAuthProvider } from '../../../../core/auth/models/auth.models';
    ...
    <div class="space-y-3">
      ...
      <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-4 bg-[#161616] text-gray-400">{{ dividerText }}</span>
        </div>
      </div>
      ...
      <button
        ...
        [disabled]="isLoading"
        class="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-4 rounded-lg transition-colors border border-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
...
export class SocialLoginButtonsComponent {
    ...
    @Input() dividerText = 'or sign in with';
